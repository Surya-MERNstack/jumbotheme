...
const menus = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                label: 'Inbox',
                type: "nav-item",
                icon: <SpeakerNotesIcon sx={{fontSize: 20}}/>
            },
            {
                uri: "/dashboards/ecommerce",
                label: 'Closed Inbox',
                type: "nav-item",
                icon: <SpeakerNotesOffIcon sx={{fontSize: 20}}/>
            },
            // {
            //     uri: "/dashboards/news",
            ...
            // }
                ...
                },
                {
                    ...
                    label: 'Appointments',
                    type: "nav-item",
                    icon: <BookOnlineIcon sx={{fontSize: 20}}/>
                },
                {
        ...
        children: [
            {
                label: 'System',
                type: "collapsible",
                icon: <SettingsSuggestIcon sx={{fontSize: 20}}/>,
                children: [
                    {
